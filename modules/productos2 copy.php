    ...
    ?>
        ...
        ?>
            <div class="menu-box contenedor-productos">
                <img style="width: auto; height: 100%;" class="product" src="<?php echo $value['imagen']; ?>" alt="image not found" />
                <h3>
                ...
                <a href="detail.php?cat=<?php echo urlencode($categoria); ?>&prod=<?php echo $value['id']; ?>" title="Ver producto">Ver producto</a>
            </div>
    <?
            $counter++;
