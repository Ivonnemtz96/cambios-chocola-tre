<main class="site-main page-spacing">
    ...
    <!-- Welcome Section -->
    <div hidden class="welcome-section container-fluid no-padding" id="nosotros">
    ...
    <!-- Team Section -->
    <div class="welcome-content" style="margin-top: 8rem;">
                    ...
                    <div role="listbox">
                        <div class="item active">
                            <div class="team-content">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-6" style="margin-top: -100px;margin-bottom: 60px;">
                                    <div class="section-header left-header">
                                        ...
                                        <img src="images/section-seprator-1.png" alt="section-seprator" width="70"
                                            height="3" />
                                        <p>
                                            ¡Hola! Somos una empresa mexicana enfocados en la fabricación de chocolate,
                                            ubicados en San José del Cabo, B.C.S.
                                            Partimos de cacao mexicano, criollo almendra blanca que proviene de las
                                            haciendas cacaotera mas grandes de México realizando el proceso conocido
                                            como: De Grano – A Barra.
                                            En Chocola-Tre te brindamos lo mejor del sabor y los beneficios del cacao
                                            criollo 100% mexicano.
                                        </p>
                                    </div>
                                    <!-- Section Header /-  -->
                                    <div class="team-contact-info">
                                        ...
                                        <ul>
                                            <li>
                                                <a title="Facebook" target="_blank"
                                                    href="https://www.facebook.com/chocolatre.bcs">
                                        ...
                                        <p>
                                            <a href="mailto:info@chocola-tre.com" title="info@chocola-tre.com"><i
                                                    class="fa fa-envelope"
                                                    aria-hidden="true"></i>info@chocola-tre.com</a>
                                        </p>
                                        <p>
