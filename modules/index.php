                        ...
                        <div role="tabpanel" class="tab-pane active" id="partycakes">
                            <div class="festival-content">
                                ...
                                <img src="images/section-seprator-1.png" alt="section-seprator-1" width="70"
                                    height="3" />
                                <p id="chocolate">
                                    El origen del chocolate: "alimento de los dioses" </br>El chocolate tiene su
                                    origen en
                                    México, donde el dios Quetzalcoatl regaló, según cuenta la leyenda maya, en
                                    árbol de
                                    cacao al hombre.
                                </p>
                                <a href="about.php" title="Ver más" class="read-more">Ver más</a>
        ...
        <div class="contact-us-1 container-fluid no-padding">
            ...
            <div class="container">
                ...
                <div class="row text-center">
                    ...
                    <div class="col-md-10 col-sm-10 col-xs-10" style="margin-top: 3rem;">
                        <div class="section-header left-header">
                            <h3>Escríbenos</h3>
                            <img src="images/section-seprator-1.png" alt="section-seprator-1" width="70" height="3">
                            <p>
